...
export const Bed = ({ hover }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className={`stroke-black ${hover} duration-500`} height="24px" viewBox="0 -960 960 960" width="24px">
...
export const Login = ({ hover, height = 'h-20', width = 'w-20' }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className={`stroke-black ${hover} duration-500 ${height} ${width}`}>
